...
class BunnyVideoDRM:
    ...
    def __init__(self,
                 ...
                 embed_url='https://iframe.mediadelivery.net/embed/6781/27dc83d0-ffe8-458b-9404-716fda06d9a1',
                 name='',
                 path=''):
...
if __name__ == '__main__':
    video = BunnyVideoDRM(
        ...
        referer='https://iframe.mediadelivery.net/embed/14161/9056dae6-83fe-453a-a768-6f91fdd392d7',
        # paste your embed link
        embed_url='https://iframe.mediadelivery.net/embed/14161/9056dae6-83fe-453a-a768-6f91fdd392d7',
