...
if __name__ == "__main__":
    ...
    subjects_url = "https://api.kipslms.com/api/v5/CandidateTestService/GetTests?TestFilter=0&SubjectId=29120&CandidateSOSId=543907&PageNumber=1&PageSize=100"  # Replace with the subjects API endpoint URL
    ...
    try:
        ...
        # for subject in subjects_data['Tests']:
            ...
            # i=i+1
        word_output_file = f"LR/SamplePhysics.docx"  # Replace with the desired output Word file name
            # test_id = subject["TestId"]
        questions_url = f"https://api.kipslms.com/api/v5/CandidateTestService/GetAttemptedTestResultDetail?TestId=84116&CandidateSOSId=543907"  # Replace with the questions API endpoint URL
