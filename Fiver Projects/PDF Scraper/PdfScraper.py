...
def Complex_pdf_Download(initial_url,directory_name,file_name):
        ...
        if response.status_code == 200:
            ...
            if script_tag:
                ...
                if fid_match:
                    ...
                    response = session.post(pdf_data_url, headers=headers, data={"fid": fid, "rand": "0.045363046087672165"})
...
def simple_download_pdf(url,session,directory_name,file_name):
    ...
    # ":method": "GET",
    # ":path": "/Monitorul-Oficial--PI--583--2024.html",
    # ":scheme": "https",
    "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7",
    "Accept-Encoding": "gzip, deflate, br, zstd",
    "Accept-Language": "en-US,en;q=0.9",
    "Cache-Control": "max-age=0",
    "Cookie": "_ga=GA1.1.1286714755.1719947054; sbjs_migrations=1418474375998%3D1; sbjs_current_add=fd%3D2024-07-02%2019%3A05%3A07%7C%7C%7Cep%3Dhttps%3A%2F%2Fmonitoruloficial.ro%2Fe-monitor%2F%7C%7C%7Crf%3Dhttps%3A%2F%2Fmonitoruloficial.ro%2F; sbjs_first_add=fd%3D2024-07-02%2019%3A05%3A07%7C%7C%7Cep%3Dhttps%3A%2F%2Fmonitoruloficial.ro%2Fe-monitor%2F%7C%7C%7Crf%3Dhttps%3A%2F%2Fmonitoruloficial.ro%2F; sbjs_current=typ%3Dtypein%7C%7C%7Csrc%3D%28direct%29%7C%7C%7Cmdm%3D%28none%29%7C%7C%7Ccmp%3D%28none%29%7C%7C%7Ccnt%3D%28none%29%7C%7C%7Ctrm%3D%28none%29%7C%7C%7Cid%3D%28none%29%7C%7C%7Cplt%3D%28none%29%7C%7C%7Cfmt%3D%28none%29%7C%7C%7Ctct%3D%28none%29; sbjs_first=typ%3Dtypein%7C%7C%7Csrc%3D%28direct%29%7C%7C%7Cmdm%3D%28none%29%7C%7C%7Ccmp%3D%28none%29%7C%7C%7Ccnt%3D%28none%29%7C%7C%7Ctrm%3D%28none%29%7C%7C%7Cid%3D%28none%29%7C%7C%7Cplt%3D%28none%29%7C%7C%7Cfmt%3D%28none%29%7C%7C%7Ctct%3D%28none%29; PHPSESSID=iv2a77a0lg369ntni1qoju46b9; sbjs_udata=vst%3D2%7C%7C%7Cuip%3D%28none%29%7C%7C%7Cuag%3DMozilla%2F5.0%20%28Windows%20NT%2010.0%3B%20Win64%3B%20x64%29%20AppleWebKit%2F537.36%20%28KHTML%2C%20like%20Gecko%29%20Chrome%2F126.0.0.0%20Safari%2F537.36; sbjs_session=pgs%3D5%7C%7C%7Ccpg%3Dhttps%3A%2F%2Fmonitoruloficial.ro%2Fcategorie-produse%2Feditura-monitorul-oficial%2Fcolectii-de-arta%2F; _ga_GH5JF2LV9N=GS1.1.1719949439.2.1.1719951477.59.0.0",
    "Priority": "u=0, i",
    ...
    try:
        ...
        print(f"Failed to download the PDF.\n{e}")
...
def main(start_date,endDate):
    for date in iterate_dates(start_date,endDate):
        ...
        for complex_link in list[1]:
            ...
            #print(url)
            Complex_pdf_Download(url,date.strftime('%Y-%m-%d'),complex_link)
